...
worker_repo_path = Path(__file__).resolve().parents[1] / "services" / "event_worker" / "app" / "infrastructure" / "repository_v2.py"
spec = importlib.util.spec_from_file_location("event_worker_repository_v2", worker_repo_path)
