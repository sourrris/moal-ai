...
export function SettingsPage() {
  ...
  const { theme, setTheme, timezone, setTimezone, tenant, window } = useUI();
  ...
  return (
    <section className="stack-lg">
      <Card>
        <h2>Session</h2>
        <p className="muted">Current signed-in profile and environment diagnostics.</p>
        ...
        <Card>
          ...
          <div className="stack-sm">
            ...
            <Select id="theme" value={theme} onChange={(event) => setTheme(event.target.value as 'light' | 'dark')}>
              ...
              <option value="dark">dark (scaffold)</option>
            </Select>
      ...
      <Card>
        ...
        <p className="muted">Keyboard-first workflow support scaffolded for operational users.</p>
      </Card>
